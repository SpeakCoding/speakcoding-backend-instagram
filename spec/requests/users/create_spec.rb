...
RSpec.describe "UsersController", type: :request do
  ...
  it "should't create users with same email" do
    post "/users.json", params: { user: { email: "alx.gsv@gmail.com", password: "123456" } }
